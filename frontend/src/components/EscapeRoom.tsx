...
const EscapeRoom = () => {
  ...
  const isWinner = localStorage.getItem("station2Done") === "true";
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let x = 0; x < canvas.width + sp; x += sp) {
        for (let y = 0; y < canvas.height + sp; y += sp) {
          ...
          const dotColor = isWinner
            ? `rgba(167,139,250,${0.025 + p * 0.055})`
            : `rgba(97,218,251,${0.025 + p * 0.055})`;
      ...
      particles.forEach((p) => {
        ...
        g.addColorStop(
          0,
          p.color.replace(")", `,${p.alpha})`).replace("rgb", "rgba"),
        );
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background: isWinner ? "#0d0a1a" : "#0c1120",
        position: "relative",
        overflow: "hidden",
    ...
    >
      ...
      >
        <div
          style={{
            ...
            right: 0,
            height: "80px",
            background: `linear-gradient(180deg, transparent, ${isWinner ? "rgba(167,139,250,0.025)" : "rgba(97,218,251,0.02)"}, transparent)`,
      ...
      <div
        style={{
          ...
          zIndex: 100,
          background: isWinner
            ? "linear-gradient(90deg, rgba(167,139,250,0.8), rgba(247,223,30,0.6), rgba(97,218,251,0.6), rgba(167,139,250,0.8))"
            : "linear-gradient(90deg, rgba(97,218,251,0.55), rgba(167,139,250,0.45), rgba(247,223,30,0.4), rgba(255,107,107,0.45))",
        }}
      />
        ...
        <>
          <div
            style={{
              ...
              height: "100%",
              background: isWinner
                ? "linear-gradient(90deg, #0d0a1a 0%, #130f24 100%)"
                : "linear-gradient(90deg, #0c1120 0%, #111827 100%)",
              zIndex: 50,
              transform:
                phase !== "hidden" ? "translateX(-100%)" : "translateX(0)",
              transition: "transform 1.4s cubic-bezier(0.77, 0, 0.18, 1) 0.1s",
              borderRight: `1px solid ${isWinner ? "rgba(167,139,250,0.2)" : "rgba(97,218,251,0.15)"}`,
            }}
          >
            <div
              style={{
                position: "absolute",
                inset: 0,
                backgroundImage: `repeating-linear-gradient(180deg, transparent 0px, ${isWinner ? "rgba(167,139,250,0.02)" : "rgba(97,218,251,0.015)"} 1px, transparent 2px)`,
              }}
            />
          </div>
          <div
            style={{
              ...
              height: "100%",
              background: isWinner
                ? "linear-gradient(270deg, #0d0a1a 0%, #130f24 100%)"
                : "linear-gradient(270deg, #0c1120 0%, #111827 100%)",
              zIndex: 50,
              transform:
                phase !== "hidden" ? "translateX(100%)" : "translateX(0)",
              transition: "transform 1.4s cubic-bezier(0.77, 0, 0.18, 1) 0.1s",
              borderLeft: `1px solid ${isWinner ? "rgba(167,139,250,0.2)" : "rgba(97,218,251,0.15)"}`,
            }}
          >
            <div
              style={{
          ...
          >
              ...
              <>
                <div
                  style={{
                    ...
                    marginBottom: "8px",
                    animation:
                      "crownFloat 3s ease-in-out infinite, fadeUp 0.6s ease both",
                  }}
                >
                  👑
                </div>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      inset: "10px",
                      borderRadius: "50%",
                      border: "1px dashed rgba(247,223,30,0.2)",
                  ...
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        "linear-gradient(135deg, rgba(167,139,250,0.2), rgba(14,10,26,0.95))",
                      border: "1px solid rgba(167,139,250,0.4)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: "26px",
                      boxShadow:
                        "0 0 40px rgba(167,139,250,0.2), inset 0 0 20px rgba(0,0,0,0.4)",
                ...
                >
                  ...
                  <span
                    style={{
                      background:
                        "linear-gradient(90deg, #a78bfa, #f7df1e, #61dafb)",
                ...
                <div
                  style={{
                    height: "1px",
                    background:
                      "linear-gradient(90deg, transparent, rgba(167,139,250,0.3), rgba(247,223,30,0.2), transparent)",
                    margin: "0 0 28px 0",
                ...
                {headerRevealed && (
                  <div
                    style={{
                      ...
                      marginBottom: "20px",
                      animation:
                        "slideReveal 0.6s cubic-bezier(0.34,1.56,0.64,1) both",
                      position: "relative",
                      overflow: "hidden",
                    }}
                  >
                    <div
                      style={{
                        ...
                        height: "120px",
                        background:
                          "radial-gradient(ellipse, rgba(167,139,250,0.12), transparent 70%)",
                        pointerEvents: "none",
                      }}
                    />
                    ...
                    >
                      ...
                      >
                        ...
                        <span style={{ color: "rgba(247,223,30,0.6)" }}>
                          "HS256"
                        </span>
                        <span style={{ color: "rgba(255,255,255,0.12)" }}>
                          ,
              ...
              <>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        "linear-gradient(135deg, rgba(97,218,251,0.15), rgba(14,20,36,0.95))",
                      ...
                      fontSize: "26px",
                      boxShadow:
                        "0 0 30px rgba(97,218,251,0.1), inset 0 0 20px rgba(0,0,0,0.4)",
                ...
                <div
                  style={{
                    height: "1px",
                    background:
                      "linear-gradient(90deg, transparent, rgba(97,218,251,0.2), transparent)",
                    margin: "0 0 32px 0",
                    animation: "fadeUp 0.6s 0.22s ease both",
                  }}
                />
            ...
            {!isWinner && (
              <div
                style={{
                  ...
                  border: "1px solid rgba(97,218,251,0.09)",
                  borderRadius: "10px",
                  padding: "20px 22px",
                  textAlign: "left",
                  marginBottom: "24px",
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Open{" "}
                      <strong style={{ color: "rgba(180,210,230,0.85)" }}>
                        DevTools
                      </strong>{" "}
                    ...
                    >
                      Find the{" "}
                      <span style={{ color: "rgba(97,218,251,0.55)" }}>
                        token
                      </span>{" "}
                      key — that's your JWT
                    </p>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      ...
                      <a
                        ...
                        style={{
                          ...
                          fontSize: "12px",
                          textDecoration: "none",
                          borderBottom: "1px solid rgba(97,218,251,0.25)",
                        }}
                      >
                        jwt.io ↗
                      </a>
                    ...
                    >
                      The payload is fully readable — it's Base64, not
                      encrypted.{" "}
                      <span style={{ color: "rgba(255,120,100,0.55)" }}>
            ...
            >
              ...
              >
                ...
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span style={{ color: "rgba(97,218,251,0.6)" }}>
                  isAuthenticated
                </span>
                <span style={{ color: "rgba(255,255,255,0.15)" }}>: </span>
                <span style={{ color: "rgba(52,211,153,0.65)" }}>true</span>
                <br />
                &nbsp;&nbsp;
                <span style={{ color: "rgba(255,255,255,0.15)" }}>{"}"}</span>
                <br />
            ...
            >
              <a
                ...
                style={{
                  ...
                  color: isWinner ? "#a78bfa" : "#61dafb",
                  background: isWinner
                    ? "rgba(167,139,250,0.06)"
                    : "rgba(97,218,251,0.06)",
                  border: `1px solid ${isWinner ? "rgba(167,139,250,0.2)" : "rgba(97,218,251,0.2)"}`,
                  borderRadius: "6px",
                  cursor: "pointer",
                  textDecoration: "none",
                  display: "inline-flex",
              ...
              <button
                ...
                style={{
                  ...
                  fontFamily: "'JetBrains Mono',monospace",
                  letterSpacing: "0.06em",
                  color: isWinner ? "#0d0a1a" : "#0c1120",
                  background: isWinner
                    ? "linear-gradient(135deg, rgba(167,139,250,0.85), rgba(124,90,240,0.75))"
                    : "linear-gradient(135deg, rgba(97,218,251,0.75), rgba(58,184,216,0.75))",
                  border: "none",
                  borderRadius: "6px",
                  cursor: "pointer",
                  boxShadow: isWinner
                    ? "0 4px 18px rgba(167,139,250,0.2)"
                    : "0 4px 18px rgba(97,218,251,0.12)",
                }}
              >
                🕵️ תחנה 1 — useContext
              </button>
