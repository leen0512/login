...
const DEMO_JWT =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyXzEyMyIsIm5hbWUiOiJEZW1vVXNlciIsImlhdCI6MTcwMDAwMDAwMCwiZXhwIjoxNzAwMDAzNjAwfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c";
...
const C = {
  ...
  header: {
    base: "rgba(129,200,220,0.55)",
    lit: "rgba(129,200,220,1)",
    bg: "rgba(129,200,220,0.06)",
    border: "rgba(129,200,220,0.25)",
  },
  payload: {
    base: "rgba(180,160,100,0.55)",
    lit: "rgba(220,195,120,1)",
    bg: "rgba(180,160,100,0.06)",
    border: "rgba(180,160,100,0.25)",
  },
  sig: {
    base: "rgba(180,120,120,0.55)",
    lit: "rgba(210,140,140,1)",
    bg: "rgba(180,120,120,0.06)",
    border: "rgba(180,120,120,0.25)",
  },
  flow: [
...
const JWT_SEGMENTS = [
  ...
  },
  {
    ...
    sub: "HMAC-SHA256",
    detail: [
      ["HMAC", 'base64(header) + "." + base64(payload)'],
      ["key", "SECRET_KEY"],
    ],
...
const TOKEN_CARDS = [
  {
    label: "Access Token",
    dot: "rgba(110,185,210,0.5)",
    lines: ["⏱ Short-lived (15 min)", "Sent with every API request"],
    code: "memory / httpOnly cookie",
    codeColor: "rgba(110,185,210,0.5)",
    bg: "rgba(110,185,210,0.03)",
    border: "rgba(110,185,210,0.09)",
  },
  {
    label: "Refresh Token",
    dot: "rgba(180,160,100,0.5)",
    lines: ["📅 Long-lived (7 days)", "Gets new access tokens"],
    code: "httpOnly cookie only!",
    codeColor: "rgba(190,120,110,0.5)",
    bg: "rgba(180,160,100,0.03)",
...
const LoginForm = ({ onLoginSuccess }: { onLoginSuccess?: () => void }) => {
  ...
  useEffect(() => {
    if (username.length === 1 && flowStep === 0) setFlowStep(1);
  }, [username]);
  useEffect(() => {
    if (password.length === 1 && flowStep <= 1) setFlowStep(2);
  }, [password]);
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        setFlowStep(1); // reset on bad credentials
      }
    } finally {
      setIsLoading(false);
    }
      ...
      >
        <div
          style={{
            ...
            height: "1px",
            background:
              "linear-gradient(90deg, transparent, rgba(110,185,210,0.3), rgba(150,125,210,0.25), transparent)",
          }}
        />
          ...
          <div>
            <div
              style={{
                fontSize: "12px",
                fontWeight: "600",
                color: "rgba(129,200,220,0.7)",
              }}
            >
              AuthContext Lab
            </div>
            <div style={{ fontSize: "10px", color: "rgba(148,165,185,0.4)" }}>
              Workshop Demo · סדנה 2
            </div>
          </div>
          <span
            style={{
              marginLeft: "auto",
              fontSize: "9px",
              color: "rgba(110,185,210,0.45)",
              background: "rgba(110,185,210,0.06)",
              border: "1px solid rgba(110,185,210,0.12)",
              borderRadius: "3px",
              padding: "2px 7px",
            }}
          >
        ...
        <div style={{ marginBottom: "16px" }}>
          <label
            style={{
              ...
              color:
                focusedField === "u"
                  ? "rgba(110,185,210,0.6)"
                  : "rgba(148,165,185,0.35)",
            ...
            <>
              <span
                style={{
                  width: "12px",
                  height: "12px",
                  border: "1.5px solid rgba(110,185,210,0.2)",
                  borderTop: "1.5px solid rgba(110,185,210,0.8)",
                  borderRadius: "50%",
        ...
        >
          <p
            style={{
              fontFamily: "'Inter',sans-serif",
              fontSize: "11px",
              color: "rgba(175,155,100,0.5)",
              lineHeight: "1.7",
            }}
          >
            <span
              style={{ color: "rgba(200,175,110,0.65)", fontWeight: "600" }}
            >
              💡 tip:
            </span>{" "}
            After login, open DevTools → Application → Local Storage, copy your
            token and paste it at{" "}
            <a
              href="https://jwt.io"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                color: "rgba(110,185,210,0.6)",
                textDecoration: "none",
                borderBottom: "1px solid rgba(110,185,210,0.2)",
              }}
            >
              jwt.io
            </a>{" "}
      ...
      >
        ...
        >
          ...
          <h2 style={{ fontSize: "17px", fontWeight: "700", color: C.text }}>
            From Login → Context Update
          </h2>
          <p
            style={{
              fontFamily: "'Inter',sans-serif",
              fontSize: "12px",
              color: "rgba(148,165,185,0.35)",
              marginTop: "4px",
            }}
          >
          ...
          >
            <p
              style={{
                fontFamily: "'Inter',sans-serif",
                fontSize: "11px",
                color: "rgba(148,165,185,0.38)",
                lineHeight: "1.7",
              }}
            >
              <span style={{ color: "rgba(205,145,90,0.6)" }}>
                ⚛ useContext
              </span>{" "}
              isn't just a global variable — it triggers a{" "}
              <strong
                style={{ color: "rgba(148,165,185,0.6)", fontWeight: "600" }}
              >
                re-render of every subscribed component
              </strong>{" "}
        ...
        >
          ...
          >
            ...
            >
              // jwt anatomy — click each segment
            </span>
            <a
              href="https://jwt.io"
              target="_blank"
              ...
              style={{
                fontFamily: "'JetBrains Mono',monospace",
                fontSize: "10px",
                color: "rgba(110,185,210,0.5)",
                textDecoration: "none",
                background: "rgba(110,185,210,0.06)",
                border: "1px solid rgba(110,185,210,0.15)",
                borderRadius: "4px",
                padding: "2px 9px",
              }}
            >
            ...
            {JWT_SEGMENTS.map((seg, i) => {
              ...
              return (
                <div
                  ...
                  onClick={() => setActiveSegment(isActive ? null : i)}
                  onMouseEnter={() => {
                    if (activeSegment === null) setActiveSegment(i);
                  }}
                  onMouseLeave={() => {
                    if (activeSegment === i) setActiveSegment(null);
                  }}
                  style={{
          ...
          {activeSegment !== null && (
            <div
              style={{
                marginTop: "10px",
                padding: "12px 14px",
                background: JWT_SEGMENTS[activeSegment].c.bg,
                border: `1px solid ${JWT_SEGMENTS[activeSegment].c.border}`,
                borderRadius: "6px",
                animation: "revealBox 0.2s ease both",
              }}
            >
              <p
                style={{
                  fontSize: "10px",
                  color: JWT_SEGMENTS[activeSegment].c.base,
                  marginBottom: "8px",
              ...
              {JWT_SEGMENTS[activeSegment].detail.map(([k, v]) => (
                <div
                  key={k}
                  style={{ display: "flex", gap: "14px", lineHeight: "1.9" }}
                >
                  <span
                    style={{
                      fontSize: "11px",
          ...
          {TOKEN_CARDS.map((t) => (
            ...
            >
              ...
              >
                ...
                />
                <span
                  style={{ fontSize: "11px", fontWeight: "600", color: t.dot }}
                >
                  {t.label}
                </span>
              </div>
